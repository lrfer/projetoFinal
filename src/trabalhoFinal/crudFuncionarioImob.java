 ...
 * @author lr_fe
 */
public class crudFuncionarioImob extends javax.swing.JFrame {
    DadosFuncionarios func;
    ArrayList<Funcionario> vetFunc;
    String modo;
    public crudFuncionarioImob(DadosFuncionarios func){
        initComponents();
        this.func = func;
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(telContato, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(telCelular, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rua, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if(index >= 0 && index < vetFunc.size()){
            vetFunc.remove(index);
        }
        modo = "Navegar";
        DisplayBtn(modo);
        this.LoadTable();
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        vetFunc.add(novo);
         ...
         if(modo.equals("Update")){
            int index = table.getSelectedRow();
            Funcionario update = this.parseFormToObject();
            vetFunc.set(index, update);
        }
        this.clearForm();
        LoadTable();
        modo = "Navegar";
   ...
   private void LoadTable(){
        ...
        if(this.vetFunc.size() > 0){
            for(Funcionario c : vetFunc){
                Object linha []= new Object[]{vetFunc.indexOf(c),c.getNome(),c.getCpf(),c.getTelContato(),
                 c.getTelCelular(),c.getCargo(),c.SalarioBase};
                model.addRow(linha);
            }
        }
   ...
   private Funcionario parseFormToObject(){
        ...
        result.setTelCelular(Integer.parseInt(telCelular.getText()));
        result.setTelefone(Integer.parseInt(telefone.getText()));
        result.setCargo(cargo.getText());
        return result;
    }
   private void fillForm(Funcionario c){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(crudFuncionarioImob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new crudFuncionarioImob().setVisible(true);
            }
        });
    }
