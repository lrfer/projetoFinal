 ...
 * @author lr_fe
 */
public class historicoTransacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(90, 90, 90)
                .addComponent(gerarArquivo, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void gerarArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_gerarArquivoActionPerformed
        t.GerarArquivoBinario(ts, "Transacao");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(historicoTransacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new historicoTransacao().setVisible(true);
            }
        });
    }
